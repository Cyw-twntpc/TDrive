...
class FileStatusWatcher:
    def __init__(self, loop: asyncio.AbstractEventLoop, db_handler: 'DatabaseConnection', status_change_callback: Callable[[List[Dict]], None], check_interval: float = 0.5):
        self._loop = loop
        self._db = db_handler
